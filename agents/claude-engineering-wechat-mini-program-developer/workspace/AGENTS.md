...
- Runtime agent id: `claude-engineering-wechat-mini-program-developer`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/engineering-wechat-mini-program-developer.md`.
