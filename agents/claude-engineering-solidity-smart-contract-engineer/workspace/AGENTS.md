...
- Runtime agent id: `claude-engineering-solidity-smart-contract-engineer`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/engineering-solidity-smart-contract-engineer.md`.
