# AGENTS.md - Agentic Identity & Trust Architect
...
- Runtime agent id: `claude-agentic-identity-trust`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/agentic-identity-trust.md`.
