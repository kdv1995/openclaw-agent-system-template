...
- Runtime agent id: `claude-engineering-autonomous-optimization-architect`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/engineering-autonomous-optimization-architect.md`.
