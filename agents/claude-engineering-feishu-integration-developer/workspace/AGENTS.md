# AGENTS.md - Feishu Integration Developer
...
- Runtime agent id: `claude-engineering-feishu-integration-developer`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/engineering-feishu-integration-developer.md`.
