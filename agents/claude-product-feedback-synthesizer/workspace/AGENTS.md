# AGENTS.md - Feedback Synthesizer
...
- Runtime agent id: `claude-product-feedback-synthesizer`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/product-feedback-synthesizer.md`.
...
- Tools declared by source: WebFetch, WebSearch, Read, Write, Edit
