...
- Runtime agent id: `claude-specialized-cultural-intelligence-strategist`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/specialized-cultural-intelligence-strategist.md`.
