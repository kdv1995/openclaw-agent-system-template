# AGENTS.md - Bilibili Content Strategist
...
- Runtime agent id: `claude-marketing-bilibili-content-strategist`.
- Original Claude source: `{{CLAUDE_HOME}}/agents/marketing-bilibili-content-strategist.md`.
